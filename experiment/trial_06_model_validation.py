...
#     def __init__(self, config_filepath=MODEL_VALIDATION_CONFIG_FILEPATH, params_filepath=PARAMS_CONFIG_FILEPATH):
...
#             val_metric_file_name=Path(config.val_metric_file_name), 
